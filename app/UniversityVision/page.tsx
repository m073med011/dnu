...
const UniversityVisionMissionContent = () => {
  return (
    <div className="w-full bg-white overflow-hidden">
      ...
      <div className="w-full max-w-screen-xl mx-auto" style={{ padding: `clamp(1.25rem, 6.25vw, 5rem) clamp(1.25rem, 6.25vw, 5rem) 0` }}>
        ...
        <div className="w-full mx-auto flex flex-col items-center mb-8 sm:mb-16" style={{ maxWidth: 'clamp(20rem, 87.5vw, 70rem)', gap: 'clamp(1rem, 1.875vw, 1.5rem)' }}>
          <div className="w-full flex flex-col-reverse sm:flex-row justify-end items-center" style={{ gap: 'clamp(0.5rem, 0.625vw, 0.5rem)' }}>
            ...
            <div className="text-[#433E78] font-bold text-right" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)' }}>
              رؤية الجامعة: 
            </div>
          </div>
          <div className="w-full flex flex-col items-end" style={{ gap: 'clamp(0.5rem, 0.625vw, 0.5rem)' }}>
            <div className="text-[#433E78] font-bold text-center" style={{ fontSize: 'clamp(0.875rem, 1.25vw, 1rem)' }}>
              رسالة الجامعة
            </div>
        ...
        {/* Images */}
        <div className="w-full flex flex-col sm:flex-row justify-between mb-8 sm:mb-16" style={{ gap: 'clamp(1rem, 2.5vw, 2rem)' }}>
          <div className="w-full mx-auto" style={{ maxWidth: 'clamp(18rem, 41.9vw, 33.5rem)' }}>
            <div className="w-full mx-auto bg-gray-300 rounded-2xl overflow-hidden" style={{ height: 'clamp(12rem, 24.8vw, 20rem)' }}>
              <Image 
                src={image}
...
const UniversityVisionMission = () => {
  return (
    <Page 
      title="رؤية ورسالة الجامعة" 
      content={<UniversityVisionMissionContent />} 
    />
  );
};
