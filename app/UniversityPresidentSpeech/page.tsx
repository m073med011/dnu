...
const PresidentMessageContent = () => {
  return (
    <section
      dir="rtl"
      className="mx-auto max-w-[1440px] min-w-[320px] w-[clamp(320px,90vw,1280px)] lg:py-10 md:py-0 py-14 mt-25 lg:mt-0 px-4 lg:px-14"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[clamp(16px,4vw,32px)] items-start">
        <div className="flex flex-col items-center lg:items-start relative lg:hover:scale-105 lg:transition-transform lg:duration-500">
          <div className="z-10 hidden lg:flex top-[20vw] w-[clamp(109.80px,28.59vw,411.75px)] px-6 py-2 bg-[#F9F9F9] rounded-2xl border border-[#B3B3B3] flex-col relative gap-2 mb-3 lg:hover:bg-white lg:hover:border-[#6F42C1] lg:hover:shadow-lg lg:transition-all lg:duration-300 lg:hover:-translate-y-1">
        ...
        <div className="text-center lg:text-right lg:hover:scale-105 lg:transition-transform lg:duration-500">
          ...
          <p className="mb-[clamp(12px,2vw,16px)] leading-relaxed font-bold lg:hover:text-[#4A4A4A] lg:duration-300 lg:hover:scale-105 lg:transform lg:transition-transform">
            بداية أتوجه بأسمى آيات الشكر والتقدير لفخامة السيد/ عبد الفتاح
            السيسي رئيس الجمهورية بمناسبة صدور قرار فخامته رقم (266) بتاريخ 24
            مايو 2025 بإنشاء جامعة دمياط الأهلية وإلى معالي الأستاذ الدكتور/
            محمد أيمن عاشور وزير التعليم العالي على دعمه الكامل والمستمر لإنشاء
            الجامعة.
          </p>

          <p className="mb-[clamp(12px,2vw,16px)] leading-relaxed font-bold lg:hover:text-[#4A4A4A] lg:duration-300 lg:hover:scale-105 lg:transform lg:transition-transform">
            كما يسعدني اليوم أن أتحدث إليكم في لحظة تاريخية متمثلة في فتح باب
            التقدم لاستقبال الدفعة الأولى بجامعة دمياط الأهلية وبدء الدراسة
            للعام الجامعي 2025/2026 في الكليات التالية: كلية التمريض، كلية
            الحاسبات والمعلومات، كلية الفنون والتصميم، كلية الآثار والسياحة،
            كلية الأعمال، وكلية الألسن.
          </p>

          <p className="mb-[clamp(12px,2vw,16px)] leading-relaxed font-bold lg:hover:text-[#4A4A4A] lg:duration-300 lg:hover:scale-105 lg:transform lg:transition-transform">
            إن إنشاء جامعة دمياط الأهلية يأتي انطلاقاً من رؤية مصر 2030،
            واستراتيجية وزارة التعليم العالي التي تهدف إلى تعزيز جودة التعليم،
            وربط مخرجاته باحتياجات سوق العمل، وتوفير بيئة تعليمية تحفز الإبداع
            والابتكار. هذه الجامعة ستكون صرحاً أكاديمياً يواكب أحدث التطورات
            العالمية في مجالات العلوم والتكنولوجيا، مع الحفاظ على قيمنا الأصيلة
            وهويتنا الوطنية.
          </p>

          <p className="mb-[clamp(12px,2vw,16px)] leading-relaxed font-bold lg:hover:text-[#4A4A4A] lg:duration-300 lg:hover:scale-105 lg:transform lg:transition-transform">
            لقد حرصنا على أن تكون جامعة دمياط الأهلية نموذجاً للتميز، من خلال
            برامج أكاديمية متميزة تلبي احتياجات العصر وتُقدم بتكلفة تنافسية،
            وشراكات استراتيجية مع الجامعات الدولية والقطاعات الصناعية لضمان جودة
            المخرجات، ومراكز بحثية متطورة تُسهم في حل المشكلات المجتمعية
            والتنموية، وبيئة جامعية متكاملة تُتيح للطلاب فرصاً للتعلم والأنشطة
            الطلابية المتنوعة.
          </p>

          <p className="mb-[clamp(12px,2vw,16px)] leading-relaxed font-bold lg:hover:text-[#4A4A4A] lg:duration-300 lg:hover:scale-105 lg:transform lg:transition-transform">
            أبنائي الطلاب... أنتم عماد المستقبل، وهذه الجامعة أُنشأت من أجلكم،
            لتُتيح لكم فرصاً تعليمية تُناسب طموحاتكم، وتُساعدكم على اكتساب
            المهارات والمعارف التي تؤهلكم لقيادة مسيرة التنمية في وطننا الغالي
            مصر.
          </p>

          <p className="mb-[clamp(12px,2vw,16px)] leading-relaxed font-bold lg:hover:text-[#4A4A4A] lg:duration-300 lg:hover:scale-105 lg:transform lg:transition-transform">
            ختاماً، أتوجه بالشكر الجزيل إلى كل من ساهم في إنجاز هذا المشروع
            الوطني الكبير، من قيادات سياسية وأكاديمية، وشركاء من القطاع الخاص،
            وجميع العاملين الذين بذلوا جهوداً مضنية لتحويل الحلم إلى حقيقة.
          </p>
...
const PresidentMessage = () => {
  return (
    <Page title="كلمة رئيس الجامعة" content={<PresidentMessageContent />} />
  );
};
